...
export default function LetterScrollTrigger({
  ...
  const helperClassName = isCompact
    ...
    : "mx-auto block max-w-2xl overflow-hidden font-garamond text-[0.95rem] italic leading-snug text-amber-900 transition-all duration-500 max-h-0 opacity-0 group-hover:mt-3 group-hover:max-h-16 group-hover:opacity-100 group-focus-visible:mt-3 group-focus-visible:max-h-16 group-focus-visible:opacity-100 md:text-base md:leading-relaxed md:group-hover:mt-4 md:group-hover:max-h-20 md:group-focus-visible:mt-4 md:group-focus-visible:max-h-20"
  const dividerClassName = isCompact
    ...
    : "mx-auto mt-2 block h-1.5 w-14 rounded-full bg-amber-800/40 transition-all duration-500 group-hover:w-24 group-hover:bg-amber-700/70 group-focus-visible:w-24 group-focus-visible:bg-amber-700/70 md:mt-3 md:w-16 md:group-hover:w-32 md:group-focus-visible:w-32"
