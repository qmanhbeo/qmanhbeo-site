...
const paperSurfaceStyle: CSSProperties = {
  ...
  boxShadow: "0 22px 42px rgba(0, 0, 0, 0.28), inset 0 1px 0 rgba(255, 248, 232, 0.42)",
  clipPath: paperClipPath,
}
  ...
  return (
    <div className={`quote-scroll mx-auto w-fit max-w-full ${className}`}>
      ...
      >
        ...
        <div
          className="absolute -left-2 top-8 h-4 w-10 -rotate-[18deg] opacity-90"
          style={{ ...tornScrapStyle, clipPath: "polygon(0 20%, 19% 0, 100% 12%, 91% 100%, 10% 84%)" }}
        />
        <div
          className="absolute right-10 top-0 h-4 w-14 rotate-[7deg] opacity-80"
          style={{ ...tornScrapStyle, clipPath: "polygon(0 36%, 16% 0, 100% 18%, 86% 100%, 10% 78%)" }}
        />
        <div
          className="absolute bottom-0 left-14 h-4 w-12 -rotate-[10deg] opacity-75"
          style={{ ...tornScrapStyle, clipPath: "polygon(0 0, 100% 18%, 88% 100%, 6% 74%)" }}
        />
        <div
          className="absolute -bottom-1 right-14 h-4 w-10 rotate-[11deg] opacity-80"
