...
import { Facebook, FileText, Github, Instagram, Linkedin, ScrollText } from "lucide-react"
  ...
  return (
    ...
    >
      ...
      <div className={`${revealClassName} relative z-10 mx-auto w-full max-w-6xl px-4 text-center sm:px-8`}>
        ...
        <div className="mx-auto mb-5 grid max-w-[20rem] grid-cols-2 gap-4 sm:max-w-md sm:gap-5 md:mb-12 md:max-w-2xl md:grid-cols-6 md:gap-6">
          <WoodenMedallion
          ...
          />
          <WoodenMedallion
            icon={<ScrollText className="h-6 w-6 md:h-8 md:w-8" />}
            label="Paths Untold"
            href="/paths-untold"
            onClick={() => playSfx("click")}
          />
