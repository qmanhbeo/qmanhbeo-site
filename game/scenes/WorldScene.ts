...
export class WorldScene extends Phaser.Scene {
  ...
  create() {
    ...
    console.log("[WORLD] Creating EnvironmentManager")
    this.environment = new EnvironmentManager(this)
    this.environment.create()
    console.log("[WORLD] EnvironmentManager.create() completed")
    ...
    const labelViewportWidth = cam.width / cam.zoom
    const isMobile = labelViewportWidth < 768
